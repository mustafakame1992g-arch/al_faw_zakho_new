...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translationDatabase = {
    'ar': {
      ...
      'open_zaincash_and_send_to':
          'افتح تطبيق ZainCash ثم أرسل إلى الرقم التالي',
      ...
      'political_election':
          'منصة سياسية شاملة للتعريف بالبرنامج الانتخابي والمرشحين',
      ...
      'check_spelling_or_try_others':
          'تأكد من كتابة الاسم بشكل صحيح أو جرّب كلمات بحث أخرى',
    },
    'en': {
      ...
      'offline': 'Offline',
      'political_election':
          'Comprehensive political platform for introducing the electoral program and candidates',
      ...
      'open_zaincash_and_send_to':
          'Open ZainCash and send to the following number',
...
''');
  ...
  double get cacheHitRate =>
      _totalRequests > 0 ? _cacheHits / _totalRequests : 0;
