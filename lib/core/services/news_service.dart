...
class NewsService {
  ...
  static Future<List<NewsModel>> getTopTickerNews({int limit = 10, bool forceRefresh = false}) async {
    final now = DateTime.now();
    if (!forceRefresh && _cache != null && _lastAt != null && now.difference(_lastAt!) < _ttl) {
